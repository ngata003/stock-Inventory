        ...
        <div class="container-fluid page-body-wrapper">
            <div class="content-wrapper">
                <div class="page-title">
                    <h2>Choisissez Votre Package</h2>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 mb-4">
                            <form action="{{route('add_package')}}" method="POST">
                                @csrf
                                <input type="hidden" name="type_package" value="">
                                ...
                                <div class="package-card featured">
                                    ...
                                    <ul class="package-features">
                                        <li> Jusqu'à 500 produits par boutique </li>
                                        ...
                                        <li class="unavailable">API personnalisée</li>
                                    </ul>

                                    <input type="submit" value="Choisir Pro" class="btn btn-pack btn-pro">
                                </div>
                            </form>
                        </div>
