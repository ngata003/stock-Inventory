...
<head>
    <meta charset="UTF-8">
    <title>Facture #{{ $data['id_facture'] }}</title>
    <style>
        body {
...
<body>
    ...
    <div class="header">
        <img src="{{ public_path('assets/images/' . $data['logo']) }}" class="logo" alt="Logo">
        <h2>FACTURE N° {{ $data['id_facture'] }}</h2>
        <p>{{ $data['date'] }}</p>
    </div>
        ...
        <table class="info-table">
            <tr>
                ...
                <td>
                    ...
                    <div class="info-content">
                        <strong>Nom :</strong> {{ $data['nom_client'] }}<br>
                        <strong>Email :</strong> {{ $data['email_client'] ?? '---' }}<br>
                    </div>
                </td>
            </tr>
        </table>
    ...
    <table class="products-table">
        ...
        <tfoot>
            ...
            <tr class="totals-row-2">
                ...
                <td style="text-align: center;">{{ number_format($data['remboursement'], 0, ',', ' ') }} FCFA</td>
            </tr>
    ...
    <!-- Footer -->
    <div class="footer">
        <p>{{ $data['site_web'] }} | {{ $data['localisation'] }}</p>
