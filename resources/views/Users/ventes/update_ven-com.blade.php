                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="form-sample" id="formulaireCommande" method="POST" action="{{route('update_ventes')}}">
                        ...
                        @if ($vente->type_operation === "vente")
                           <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label">Nom Client</label>
                                        <div class="col-sm-8">
                                            <input type="text" value="{{$vente->nom_client}}" name="nom_client" class="form-control" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="email" value="{{$vente->email_client}}" name="email_client" class="form-control" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        @if ($vente->type_operation === "commande")
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                    <input type="tel" value="{{$vente->contact_client}}" placeholder="entrez le contact du client" name="contact_client" class="form-control" />
                                    </div>
                                </div>
                                </div>
                                <div class="col-md-6">
                        ...
                        <div id="commandesContainer">
                            @foreach ($vente_details as $i => $ven_det)
                                <div class="row align-items-center g-3 mb-3" id="nouvelle_commande{{$i}}">
                                    <div class="col-md-3">
                                        <div class="autocomplete-container">
                                            <input type="text" id="nom_produit{{$i}}" value="{{$ven_det->nom_produit}}" name="nom_produit{{$i}}" class="form-control"
                                                placeholder="Entrer un nom de produit" onkeyup="autoCompletion_produits{{$i}}" />
                                            <div id="suggestions_{{$i}}" class="autocomplete-suggestions"></div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <input type="number" id="quantite{{$i}}" value="{{$ven_det->qte}}" name="qte{{$i}}" class="form-control"
                                            placeholder="Entrer une quantité" oninput="calculTotal({{$i}})" />
                                    </div>
                                    <div class="col-md-3">
                                        <input type="number" id="prix_unitaire{{$i}}" value="{{$ven_det->prix_unitaire}}" name="prix_unitaire{{$i}}" class="form-control"
                                            placeholder="Prix unitaire" readonly />
                                    </div>
                                    <div class="col-md-3">
                                        <input type="number" value="{{$ven_det->montant_total}}" id="total{{$i}}" name="montant_total{{$i}}" class="form-control" placeholder="Total"
                                            readonly />
                                    </div>
                                </div>
                            @endforeach
                        ...
                        <div class="row align-items-center g-3 mb-3">
                            ...
                            <div class="col-md-3">
                                <input type="number" id="total_commandee" value="{{$vente->montant_total}}"  name="montant_total" class="form-control" placeholder=" total commande" oninput="calculerReste()"  />
                            </div>
                            <div class="col-md-3">
                                <input type="number" id="montant_paye" value="{{$vente->montant_paye}}" name="montant_paye" class="form-control" placeholder="montant verse" oninput="calculerReste()" />
                            </div>
                            <div class="col-md-3">
                                <input type="number" id="reste" value="{{$vente->montant_remboursé}}" name="montant_rembourse" class="form-control" placeholder="reste" readonly />
                            </div>
                            <input type="hidden" name="numRows" id="numRows">
                            <input type="hidden" name="type_operation" value="{{$vente->type_operation}}">
                            <input type="hidden" name="fk_vente" value="{{$vente->id}}">
                        </div>
