  ...
  <body>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-sm-flex justify-content-between align-items-start">
                      ...
                      <div>
                        <button class="btn btn-primary btn-lg text-white mb-0 me-0" data-bs-toggle="modal" data-bs-target="#shopModal" type="button"><i class="mdi mdi-account-plus"></i>Ajouter un fournisseur </button>
                      </div>
                    </div>
                    <div class="table-responsive">
                      <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="text-center text-muted">Aucun fournisseur enregistré</td>
                                </tr>
                            @endforelse
                        </tbody>
                      </table>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"> Ajouter une fournisseur   </h5>
                    <button type="button" class="btn text-white fs-4" data-bs-dismiss="modal" aria-label="Close">&times;</button>
                </div>

                <div class="modal-body">
                    <form method="POST" action="{{route('add_fournisseurs')}}" id="formulaire" >
                        @csrf
                            <div class="mb-3">
                                <label for="centreName" class="form-label">Nom Fournisseur </label>
                                <input type="text" name="nom_fournisseur" class="form-control" id="" placeholder="entrer le nom du fournisseur ">
                            </div>
                            <div class="mb-3">
                                <label for="centreName" class="form-label"> adresse </label>
                                <input type="text" name="adresse" class="form-control" id="" placeholder="entrer la localisation du fournisseur ">
                            </div>
                            <div class="mb-3">
                                <label for="centreName" class="form-label"> telephone </label>
                                <input type="tel" name="telephone" class="form-control" id="" placeholder="entrer un contact valide ">
                            </div>
                            <div class="mb-3">
                                <label for="centreName" class="form-label">Email </label>
                                <input type="email" name="email" placeholder="entrez une adresse email du fournisseur valide " class="form-control" >
                            </div>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editModalLabel"> Modifier les informations des fournisseurs   </h5>
                ...
                <div class="modal-body">
                    <form method="POST" enctype="multipart/form-data"  action="" id="editForm" >
                        ...
                        <div class="mb-3">
                            <label for="centreName" class="form-label">Nom Fournisseur </label>
                            <input type="text" name="nom_fournisseur" class="form-control" id="nom_fournisseur" placeholder="entrer le nom du fournisseur ">
                        </div>
                        <div class="mb-3">
                            <label for="centreName" class="form-label"> adresse </label>
                            <input type="text" name="adresse" class="form-control" id="adresse" placeholder="entrer la localisation du fournisseur ">
                        </div>
                        <div class="mb-3">
                            <label for="centreName" class="form-label"> telephone </label>
                            <input type="tel" name="telephone" class="form-control" id="telephone" placeholder="entrer un contact valide ">
                        </div>
                        <div class="mb-3">
                            <label for="centreName" class="form-label">Email </label>
                            <input type="email" name="email" placeholder="entrez une adresse email du fournisseur valide " id="email" class="form-control" >
                        </div>
                        <div class="button-container ">
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="deleteModalLabel">Supprimer le fournisseur </h5>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content border-danger shadow-lg">
                <div class="modal-body text-center p-4">
                    ...
                    @if(session('fournisseurs_delete'))
                        <h5 class="modal-title" id="deleterModalLabel">{{session('fournisseurs_delete')}}</h5>
                    @endif
            ...
            <div class="modal-content border-success shadow-lg">
                <div class="modal-body text-center p-4">
                    ...
                    @if(session('success_add'))
                        <h5 class="text-success fw-bold mb-2">{{ session('success_add') }}</h5>
                    @endif
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content border-primary shadow-lg">
                <div class="modal-body text-center p-4">
                    ...
                    @if(session('fournisseur_updated'))
                        <h5 class="modal-title" id="deleterModalLabel">{{session('fournisseur_updated')}}</h5>
                    @endif
    ...
    <script>
        function openEditModal(button) {
            ...
            const updateFournisseurUrl = @json(route('update_fournisseurs', ['id' => '__ID__']));


            document.getElementById('editModalLabel').textContent = ' Modifier un fournisseur ';
            document.getElementById('editForm').action = updateFournisseurUrl.replace('__ID__', id);
            document.getElementById('nom_fournisseur').value = nom;
    ...
    <script>
        ...
        const deleteFournisseursUrl =@json(route('delete_fournisseurs', ['id' => '__ID__'])) ;
